...
**Core Features:**
- ✅ **Traditional App Capabilities**: Retains full React Native application development capabilities
- ✅ **Game Engine Integration**: Seamless integration with Godot Engine, supporting 2D/3D game development
- ✅ **Hybrid Architecture**: Combines traditional UI and game scenes in a single application
- ✅ **Thread Safety**: Uses Worklet mechanism for thread-safe Godot API calls
- ✅ **Platform Support**: Complete iOS and Android platform support
...
**Godot Integration Documentation**: See [GODOT_INTEGRATION.md](./GODOT_INTEGRATION.md)
...
This project is based on [BearStudio](https://www.bearstudio.fr/)'s [Start UI Native](https://github.com/bearstudio/start-ui-native) template, with Godot game engine functionality integrated to create a new game development template.

**Original Project**: [https://github.com/bearstudio/start-ui-native](https://github.com/bearstudio/start-ui-native)

**Acknowledgments**: Thanks to the BearStudio Team for providing an excellent base template, enabling us to seamlessly integrate game engine functionality into React Native applications.
